...
namespace ProductManagement.Helper
{
    ...
    {
        public ProductManagementContext _context;
        public Authorization(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, ProductManagementContext context) : base(options, logger, encoder, clock)
        {
            _context = context;
        }
